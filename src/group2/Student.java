...
public class Student {
    ...
    public static void setStudent(int sid) throws SQLException {
        ...
        while (rs.next()) {
            ...
            // Retrieves data from Student table
            while (rs.next()) {
                addressStreetNumber = rs2.getInt(2);
                addressStreetName = rs2.getString(4);
                addressSuite = rs2.getString(3);
                addressState = rs2.getString(6);
                addressCity = rs2.getString(5);
                addressZIPCode = rs2.getString(7);
