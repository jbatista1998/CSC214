...
CREATE TABLE `Course_has_Subjects` (
  ...
  PRIMARY KEY (`Course_Course ID`,`Subjects_id`),
  KEY `fk_Course_has_Subjects_Subjects1_idx` (`Subjects_id`),
  KEY `fk_Course_has_Subjects_Course1_idx` (`Course_Course ID`),
  CONSTRAINT `fk_Course_has_Subjects_Course1` FOREIGN KEY (`Course_Course ID`) REFERENCES `Course` (`Course ID`),
  CONSTRAINT `fk_Course_has_Subjects_Subjects1` FOREIGN KEY (`Subjects_id`) REFERENCES `Subjects` (`id`)
...
-- Dump completed on 2020-04-10 21:04:06
