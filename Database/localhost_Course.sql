...
CREATE TABLE `Course` (
  ...
  `Course Name` varchar(120) NOT NULL,
  `Course Number` int(11) NOT NULL,
  `Credit Hours` int(11) DEFAULT NULL,
  `Start Date` date NOT NULL,
  `End Date` date NOT NULL,
  `Days` varchar(45) DEFAULT NULL,
  `Start Time` int(11) DEFAULT NULL,
  `End Time` int(11) DEFAULT NULL,
  PRIMARY KEY (`Course ID`),
  UNIQUE KEY `Course ID_UNIQUE` (`Course ID`)
